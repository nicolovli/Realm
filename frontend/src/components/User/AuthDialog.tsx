      ...
      <DialogContent className="max-w-md max-h-[90vh] flex flex-col overflow-hidden bg-white dark:bg-darkpurple">
        ...
        <p className={"mt-4 text-center text-sm cursor-pointer " + darkmode}>
          {mode === "login" ? (
            <>
              New to Realm?{" "}
              <span className="underline text-blue-600 dark:text-blue-300" onClick={() => setMode("register")}>
                Create your portal
              </span>{" "}
              and start exploring!
            </>
            ...
            <>
              ...
              <span className="underline text-blue-600 dark:text-blue-300" onClick={() => setMode("login")}>
                Enter Realm
              </span>{" "}
